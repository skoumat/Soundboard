...
fun EditSoundScreen(
    ...
    val viewModel: EditSoundViewModel = viewModel(
        factory = EditSoundViewModelFactory((LocalContext.current.applicationContext as SoundboardApp).repository, savedStateHandle)
    )
    ...
    Column(modifier = Modifier.fillMaxSize()) {
        ...
        Column(
            ...
            Button(
                onClick = { viewModel.selectSoundFile() },
                modifier = Modifier.fillMaxWidth()
            ) {
                Text(viewModel.soundFileName ?: "Select Sound File")
            }
